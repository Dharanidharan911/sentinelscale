...
class DecisionEngine:
    ...
    async def evaluate_decision(self, context: DecisionContext) -> ScalingDecision:
        with create_span(
            "decision_engine.evaluate_decision",
            attributes={
                "workload": context.target_workload,
            ...
            if span:
                ...
                span.set_attribute("decision.recommended_pods", recommended_pods)
                span.set_attribute("decision.baseline_hpa_pods", baseline_hpa_pods)
                span.set_attribute("decision.pod_delta", pod_delta)
